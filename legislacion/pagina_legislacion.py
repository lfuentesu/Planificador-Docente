...
def consultar_legislacion_ia(client, pregunta):
    """Consulta al modelo de IA sobre la legislación laboral docente en Chile probando modelos vigentes en Groq."""
    prompt_sistema = """
    ...
    # Lista de nombres de modelos compatibles con las distintas versiones de la API de Groq
    modelos_candidatos = [
